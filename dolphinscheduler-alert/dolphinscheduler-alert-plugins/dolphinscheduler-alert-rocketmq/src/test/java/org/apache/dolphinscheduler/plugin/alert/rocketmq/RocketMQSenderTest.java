...
public class RocketMQSenderTest {
    ...
    public void initRocketMQConfig(){
        ...
        rocketMQConfig.put(RocketMQParamsConstants.NAME_ROCKET_MQ_NAME_SERVER_ADDRESS, "xxxx:9876");
        rocketMQConfig.put(RocketMQParamsConstants.NAME_ROCKET_MQ_TOPIC, "testTopic");
