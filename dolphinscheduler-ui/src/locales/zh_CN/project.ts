...
export default {
  ...
  node: {
    ...
    src_filter: '源表过滤条件',
    data_filter: '数据过滤',
    data_filter_tips: 'where条件，请勿输入where关键字',
    split_field: '切分键',
    split_field_tips: '根据配置的字段进行数据分片，实现并发读取，只支持整型',
    dsPartitions_field: '分区信息',
    dsPartitions_field_tips: '请填分区信息',
    write_mode_field: '主键冲突',
    write_mode_field_tips: '请填写主键冲突',
    rule_mode_field: '清理规则',
    rule_mode_field_tips: '请填写清理规则',
    elastic_search_datax_params_index_field: '索引',
    elastic_search_datax_params_field_index_tips: '请填写索引',
    elastic_search_datax_params_type_field: '索引类型',
    elastic_search_datax_params_field_type_tips: '请填写索引类型',
    elastic_search_datax_params_cleanUp_field: '是否删除原表',
    elastic_search_datax_params_splitter_field: '分隔符号',
    elastic_search_datax_params_field_splitter_tips: '请填写分隔符号',
    elastic_search_datax_params_alias_field: '别名',
    elastic_search_datax_params_field_alias_tips: '请填写别名',
    elastic_search_datax_params_aliasMode_field: '别名模式',
    elastic_search_datax_params_field_aliasMode_tips: '请填写别名模式',
    elastic_search_datax_params_ignoreWriteError_field: '忽略写入错误',
    elastic_search_datax_params_ignoreParseError_field: '忽略解析错误',
    elastic_search_datax_params_tyrSize_field: '失败后重试次数',
    elastic_search_datax_params_field_tyrSize_tips: '请填写失败后重试次数',
    elastic_search_datax_params_timeout_field: '客户端超时时间',
    elastic_search_datax_params_field_timeout_tips: '请填写客户端超时时间',
    elastic_search_datax_params_discovery_field: '启用节点发现',
    elastic_search_datax_params_compression_field: '开启压缩',
    elastic_search_datax_params_multiThread_field: '多线程并发',
    elastic_search_datax_params_dynamic_field: '使用ES的mappings',
    elastic_search_datax_params_setting_field: 'Settings',
    hive_tips: '请确认已创建分区初始化任务或者分区已存在！',
    hive_text: '暂无分区信息！',
    data_select_in_divider: '数据源选择：数据来源',
    data_select_out_divider: '数据源选择：数据去向',
    elastic_search_datax_params_setting: 'ELASTICSEARCH:基本配置',
    elastic_search_datax_params_setting_advanced: 'ELASTICSEARCH:高级配置',
    divider_end: '',
    field_mapping_label: '字段映射',
    field_mapping_name_tips: '请将字段映射字段填写完整！',
    field_mapping_type_tips: '请将字段映射类型填写完整！',
    field_batchSize: '批量写入条数',
    field_batchSize_tips: '请填写批量写入条数',
    field_channel: '任务期望最大并发数',
    field_channel_tips: '请填写任务期望最大并发数',
